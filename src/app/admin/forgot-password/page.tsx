...
export default function ForgotPasswordPage() {
  ...
  return (
    <div className="min-h-screen bg-navy px-4 py-24 flex items-center justify-center">
      <div className="gold-glass rounded-2xl p-8 md:p-10 shadow-2xl w-full max-w-md">
        <h1 className="text-3xl font-bold text-primary mb-3">Forgot Password</h1>
